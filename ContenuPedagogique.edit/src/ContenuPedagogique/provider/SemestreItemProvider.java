...
/**
 * This is the item provider adapter for a {@link ContenuPedagogique.Semestre} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Semestre_nom_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Semestre_nom_feature", "_UI_Semestre_type"),
				 ContenuPedagogiquePackage.Literals.SEMESTRE__NOM,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ContenuPedagogiquePackage.Literals.SEMESTRE__UES,
				 true,
				 false,
				 true,
				 null,
