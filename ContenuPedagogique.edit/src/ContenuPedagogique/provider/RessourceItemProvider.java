...
/**
 * This is the item provider adapter for a {@link ContenuPedagogique.Ressource} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ContenuPedagogiquePackage.Literals.RESSOURCE__NOM,
				 true,
				 false,
				 false,
	...
	protected void addLienPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ressource_lien_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ressource_lien_feature", "_UI_Ressource_type"),
				 ContenuPedagogiquePackage.Literals.RESSOURCE__LIEN,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
